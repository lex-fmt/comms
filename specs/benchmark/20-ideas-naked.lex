...
3. Lex: ideas. naked.
    ...
    3.2. The Form in Format
        ...
        - Indentation: leverages human cognition's ability to derive similarity and relationship visually by layout. - The Great Plain Text Tradition: for centuries people have agreed on standard ways to represent text, by using titles, dashes, blank lines and so forth. Lex draws heavily on this tradition. - Minimal syntax: if you consider markdown *bold* and _italics_ part of the current lexicon, Lex only adds the Definition:: and :: label constructs, both using the :: marker. 
    ...
    3.3 The Primitives
        ...
        3.3.4. Verbatim Content
            ...
            Lex is proud of itself, but happy to acknowledge that ideas thrive in diversity. Verbatim blocks can represent content that is not Lex formatted:
        ...
        3.3.5. Annotations
            ...
            :: note-editor :: Maybe this could be better rephrased? Not sure how annotations are linked to the closes element comes in from this phrase. 
            :: note.author :: Done, I'm still keeping it simple, though. They can be attached to any content, and are connected through the annotation position.
        ...
        3.3.7. Inlines
            ...
            These are rendered instructions such as this should be *strong* or _emphasized_ and that a word is a `technical term` or math #$$E=mc^2$$#.
